    ...
    <div class="col-md-5">
        <div class="form-group">
            ...
            <div class="input-outer">
                {{ form.render('first_name', ['class': 'form-control','placeholder':'required']) }}
            </div>
        </div>
        <div class="form-group">
            {{ form.label('last_name', ['class': 'control-label']) }}
            <div class="input-outer">
                {{ form.render('last_name', ['class': 'form-control','placeholder':'required']) }}
            </div>
        </div>
        <div class="form-group">
            {{ form.label('email', ['class': 'control-label']) }}
            <div class="input-outer">
                {{ form.render('email', ['class': 'form-control','placeholder':'required']) }}
            </div>
        </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="input-outer">
                {{ form.render('mobile', ['id':'mobile','class': 'form-control','placeholder':'required','maxlength':'10']) }}
            </div>
        </div>
        <div class="form-group">
            {{ form.label('password', ['class': 'control-label']) }}
            <div class="input-outer">
                {{ form.render('password', ['class': 'form-control','placeholder':'required']) }}
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="input-outer">
                {{ password_field('repeatPassword', 'class': 'input-xlarge form-control','placeholder':'required','size':'32') }}
