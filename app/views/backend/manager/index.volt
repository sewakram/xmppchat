...
<div class="col-md-12 user_list_admin">
  ...
  <div class="row user_list_admin_row">
    <div class="" id="userGrid_Filter" >
      ...
      <input class="filter_input" size="35" id="franchisee" name="franchisee" type="text"  placeholder="Manager" autocomplete="off" />
       ...
       <a href="{{ baseUri }}/manager/new" class="btn btn-primary" id="createbtn"><span class="glyphicon glyphicon-plus"></span> Add Manager</a>   
  </div>
</div>
  <div id="userGrid" ></div>
...
try{
    if (item["firstname"].toLowerCase().indexOf(current_key.toLowerCase()) == -1 && String(item["mobile"]).indexOf(String(current_key)) == -1 ){
        return false;
      }
   ...
   var columns = [
    ...
    {id: "firstname", name:"First Name", field:"firstname", cssClass:"username_class", sortable:true,headerCssClass:'username_header',  formatter:FormatterFirstname},    
    {id: "lastname", name:"Last Name", field:"lastname", cssClass:"lastname_class", sortable:true,headerCssClass:'lastname_header',  formatter:FormatterLastname},    
  ...
  if (login_type=='Super Admin')
    var admincol ={id: "adminname", name:"adminname", field:"adminname", cssClass:"mobile_class", sortable:true,headerCssClass:'mobile_header',  formatter:Formatteradminname,editor:Slick.Editors.Text};
  ...
  // return "<div class="+value+"><b>"+value+"</b></div>";
  // }
  function Formatteradminname(row, cell, value, columnDef, dataContext) {
  return "<div class="+value+"><b>"+value+"</b></div>";
  }
 /* function FormatterCredit_validity(row, cell, value, columnDef, dataContext) {
  ...
  function FormatterId(row, cell, value, columnDef, dataContext) {
    ...
    // else
      ...
      return "<div class='btn-group'><a id='listbtn' data-id="+value+" class='btn btn-primary'  href='/manager/view/"+value+"'><i class='glyphicon glyphicon-list'></i> View</a><a id='listbtn' data-id="+value+" class='btn btn-primary'  href='/manager/permission/"+value+"'><i class='glyphicon glyphicon-wrench'></i></a><a id='editbtn' href=/manager/edit/"+value+" class='btn btn-success'><i class='glyphicon glyphicon-pencil'></i></a><a onclick='return ConfirmDel("+value+");' id='cancelbtn' href='#' class='btn btn-danger'><i class='glyphicon glyphicon-remove'></i></a></div>";
  }
