...
<style>
    ...
    .marginchk{ margin-left: 40%!important;}
    .marginemob{margin-left:26%!important;}
    .marginename{margin-left:13%!important;}
  </style>
  ...
  bootbox.dialog({
                ...
                buttons: {
                    success: {
                        ...
                        callback: function () {
          // var checked=dataView.getRowById();
          var selectedData = [],selectedIndexes;

          selectedIndexes = gridu.getSelectedRows();
          console.log(selectedIndexes);
          $.each(selectedIndexes, function (index, value) {
          selectedData.push(gridu.getData().getItem(value));
          });

          console.log('selectedData ',selectedData);
                           /**************************************************************************/
                           // var _selected=$('#ContactGrid_popup .grid-canvas').children();
...
function testgrid(){
  ...
  var newdata=[];
var flag=0;
$.each(datau,function(key,val){
    flag=0;
  $.each(data,function(k,v){
    console.log(val.mobilee);
    console.log(v.mobile);

      if(val.mobilee==v.mobile)
      {
        flag=1;
      }
  });
  ...
  var columnsu = [
    ...
    {id: "name", name:"Name", field:"name",cssClass:"marginename", sortable:true},    
    {id: "mobilee", name:"Mobile", field:"mobilee",cssClass:"marginemob", sortable:false}
   ];
