...
<div class="col-md-5">
     ...
     <div class="form-group">
            <label class="control-label" for="organization">Organization</label><div class="input-outer">
            <input type="text" class="form-control" name="organization" id="organization" value="<?php echo $user->organization;?>"> 
    </div>  </div>
     <div class="form-group">
            <label class="control-label" for="address">Address</label><div class="input-outer">
    ...
    <div class="form-group">
            <label class="control-label col-sm-3" for="senderid" class="control-label">Sender Id</label><div class="input-outer">
