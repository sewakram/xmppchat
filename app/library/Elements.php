...
class Elements extends Component
{
    private $_headerMenu = array(
        'navbar-left' => array(
            ...
            'feedback' => array(
                'caption' => '<span class="glyphicon glyphicon-pencil"></span> Poll',
                'action' => '',
                'dropdown' => array(
                    'new' => array(
            ...
            'group' => array(
                'caption' => '<span class="glyphicon glyphicon-phone-alt"></span> Groups',
                'action' => ''
            ),
            'user' => array(
            ...
            'manager' => array(
                'caption' => '<span class="glyphicon glyphicon-user"></span> Managers',
                'action' => ''
            ),
            'clientsetting' => array(
    ...
    public function getMenu()
    {
            ...
            switch ($login_type) {
                case "Franchisee":
                     ...
                     unset($this->_headerMenu['navbar-left']['appuser']);
                ...
                case "Manager":
                     ...
                     unset($this->_headerMenu['navbar-left']['franchisee']);
                     unset($this->_headerMenu['navbar-left']['user']);
                     unset($this->_headerMenu['navbar-left']['manager']);
                     unset($this->_headerMenu['navbar-left']['clientsetting']);
                     unset($this->_headerMenu['navbar-left']['discount']);
                     unset($this->_headerMenu['navbar-left']['permissions']);
                     if($user_permission['contact_groups'] == 'No')
                        unset($this->_headerMenu['navbar-left']['group']);
